...
```
Total ad / tracking block list 屏蔽追踪广告总数: 115331

Total allowlist list 允许名单总数: 1271

Total combine list 结合总数： 115190

Total deadblock list 失效屏蔽广告域名： 28985

Total deadallow list 失效允许广告域名： 94

Update 更新时间: 2021-01-09
```
### UPTODATE 保持最新<br/>
