...
```
Total ad / tracking block list 屏蔽追踪广告总数: 117247

Total allowlist list 允许名单总数: 1230

Total combine list 结合总数： 117104

Total deadblock list 失效屏蔽广告域名： 30219

Total deadallow list 失效允许广告域名： 112

Update 更新时间: 2021-01-31
```
### UPTODATE 保持最新<br/>
