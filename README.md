...
```
Total ad / tracking block list 屏蔽追踪广告总数: 121602

Total allowlist list 允许名单总数: 1237

Total combine list 结合总数： 121460

Total deadblock list 失效屏蔽广告域名： 31220

Total deadallow list 失效允许广告域名： 105

Update 更新时间: 2021-03-05
```
### UPTODATE 保持最新<br/>
