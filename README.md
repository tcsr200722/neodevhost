...
```
Total ad / tracking block list 屏蔽追踪广告总数: 115308

Total allowlist list 允许名单总数: 1267

Total combine list 结合总数： 115167

Total deadblock list 失效屏蔽广告域名： 29229

Total deadallow list 失效允许广告域名： 98

Update 更新时间: 2021-01-10
```
### UPTODATE 保持最新<br/>
