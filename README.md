...
```
Total ad / tracking block list 屏蔽追踪广告总数: 127455

Total allowlist list 允许名单总数: 1236

Total combine list 结合总数： 127331

Total deadblock list 失效屏蔽广告域名： 26034

Total deadallow list 失效允许广告域名： 107

Update 更新时间: 2021-04-28
```
### UPTODATE 保持最新<br/>
