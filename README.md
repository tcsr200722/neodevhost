...
```
Total ad / tracking block list 屏蔽追踪广告总数: 98246

Total allowlist list 允许名单总数: 1325

Total combine list 结合总数： 98115

Total deadblock list 失效屏蔽广告域名： 16962

Total deadallow list 失效允许广告域名： 87

Update 更新时间: 2020-11-12
```
### UPTODATE 保持最新<br/>
