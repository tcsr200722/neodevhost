...
```
Total ad / tracking block list 屏蔽追踪广告总数: 120456

Total allowlist list 允许名单总数: 1549

Total combine list 结合总数： 120194

Total deadblock list 失效屏蔽广告域名： 19829

Total deadallow list 失效允许广告域名： 90

Update 更新时间: 2020-12-22
```
### UPTODATE 保持最新<br/>
