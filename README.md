...
```
Total ad / tracking block list 屏蔽追踪广告总数: 124071

Total allowlist list 允许名单总数: 1236

Total combine list 结合总数： 123947

Total deadblock list 失效屏蔽广告域名： 26071

Total deadallow list 失效允许广告域名： 107

Update 更新时间: 2021-04-19
```
### UPTODATE 保持最新<br/>
