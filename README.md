...
```
Total ad / tracking block list 屏蔽追踪广告总数: 117227

Total allowlist list 允许名单总数: 1235

Total combine list 结合总数： 117087

Total deadblock list 失效屏蔽广告域名： 29917

Total deadallow list 失效允许广告域名： 107

Update 更新时间: 2021-01-30
```
### UPTODATE 保持最新<br/>
