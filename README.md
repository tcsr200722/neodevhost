...
```
Total ad / tracking block list 屏蔽追踪广告总数: 115899

Total allowlist list 允许名单总数: 1256

Total combine list 结合总数： 115756

Total deadblock list 失效屏蔽广告域名： 29955

Total deadallow list 失效允许广告域名： 86

Update 更新时间: 2021-01-22
```
### UPTODATE 保持最新<br/>
