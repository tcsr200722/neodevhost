...
```
Total ad / tracking block list 屏蔽追踪广告总数: 126440

Total allowlist list 允许名单总数: 1233

Total combine list 结合总数： 126298

Total deadblock list 失效屏蔽广告域名： 32632

Total deadallow list 失效允许广告域名： 109

Update 更新时间: 2021-03-18
```
### UPTODATE 保持最新<br/>
