...
```
Total ad / tracking block list 屏蔽追踪广告总数: 96867

Total allowlist list 允许名单总数: 1321

Total combine list 结合总数： 96737

Total deadblock list 失效屏蔽广告域名： 17344

Total deadallow list 失效允许广告域名： 91

Update 更新时间: 2020-11-02
```
### UPTODATE 保持最新<br/>
