...
```
Total ad / tracking block list 屏蔽追踪广告总数: 126644

Total allowlist list 允许名单总数: 1236

Total combine list 结合总数： 126502

Total deadblock list 失效屏蔽广告域名： 29855

Total deadallow list 失效允许广告域名： 106

Update 更新时间: 2021-03-13
```
### UPTODATE 保持最新<br/>
