...
```
Total ad / tracking block list 屏蔽追踪广告总数: 128170

Total allowlist list 允许名单总数: 1244

Total combine list 结合总数： 128045

Total deadblock list 失效屏蔽广告域名： 25923

Total deadallow list 失效允许广告域名： 101

Update 更新时间: 2021-05-20
```
### UPTODATE 保持最新<br/>
