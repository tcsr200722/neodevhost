...
```
Total ad / tracking block list 屏蔽追踪广告总数: 125775

Total allowlist list 允许名单总数: 1237

Total combine list 结合总数： 125634

Total deadblock list 失效屏蔽广告域名： 29868

Total deadallow list 失效允许广告域名： 105

Update 更新时间: 2021-03-12
```
### UPTODATE 保持最新<br/>
