...
```
Total ad / tracking block list 屏蔽追踪广告总数: 97270

Total allowlist list 允许名单总数: 1326

Total combine list 结合总数： 97140

Total deadblock list 失效屏蔽广告域名： 18632

Total deadallow list 失效允许广告域名： 89

Update 更新时间: 2020-12-09
```
### UPTODATE 保持最新<br/>
