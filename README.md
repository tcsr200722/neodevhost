...
```
Total ad / tracking block list 屏蔽追踪广告总数: 128088

Total allowlist list 允许名单总数: 1246

Total combine list 结合总数： 127961

Total deadblock list 失效屏蔽广告域名： 25886

Total deadallow list 失效允许广告域名： 99

Update 更新时间: 2021-05-17
```
### UPTODATE 保持最新<br/>
