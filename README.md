...
```
Total ad / tracking block list 屏蔽追踪广告总数: 115395

Total allowlist list 允许名单总数: 1257

Total combine list 结合总数： 115264

Total deadblock list 失效屏蔽广告域名： 29104

Total deadallow list 失效允许广告域名： 91

Update 更新时间: 2020-12-23
```
### UPTODATE 保持最新<br/>
