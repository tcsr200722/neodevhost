...
```
Total ad / tracking block list 屏蔽追踪广告总数: 99074

Total allowlist list 允许名单总数: 1326

Total combine list 结合总数： 98944

Total deadblock list 失效屏蔽广告域名： 17617

Total deadallow list 失效允许广告域名： 88

Update 更新时间: 2020-11-24
```
### UPTODATE 保持最新<br/>
