...
```
Total ad / tracking block list 屏蔽追踪广告总数: 129201

Total allowlist list 允许名单总数: 1241

Total combine list 结合总数： 129076

Total deadblock list 失效屏蔽广告域名： 25929

Total deadallow list 失效允许广告域名： 104

Update 更新时间: 2021-05-23
```
### UPTODATE 保持最新<br/>
