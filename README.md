...
```
Total ad / tracking block list 屏蔽追踪广告总数: 117254

Total allowlist list 允许名单总数: 1258

Total combine list 结合总数： 117107

Total deadblock list 失效屏蔽广告域名： 29418

Total deadallow list 失效允许广告域名： 84

Update 更新时间: 2021-01-24
```
### UPTODATE 保持最新<br/>
