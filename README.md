...
```
Total ad / tracking block list 屏蔽追踪广告总数: 97271

Total allowlist list 允许名单总数: 1319

Total combine list 结合总数： 97143

Total deadblock list 失效屏蔽广告域名： 18644

Total deadallow list 失效允许广告域名： 96

Update 更新时间: 2020-12-07
```
### UPTODATE 保持最新<br/>
