...
```
Total ad / tracking block list 屏蔽追踪广告总数: 99422

Total allowlist list 允许名单总数: 1324

Total combine list 结合总数： 99292

Total deadblock list 失效屏蔽广告域名： 17474

Total deadallow list 失效允许广告域名： 88

Update 更新时间: 2020-11-06
```
### UPTODATE 保持最新<br/>
