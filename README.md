...
```
Total ad / tracking block list 屏蔽追踪广告总数: 116582

Total allowlist list 允许名单总数: 1259

Total combine list 结合总数： 116437

Total deadblock list 失效屏蔽广告域名： 29446

Total deadallow list 失效允许广告域名： 83

Update 更新时间: 2021-01-23
```
### UPTODATE 保持最新<br/>
