...
```
Total ad / tracking block list 屏蔽追踪广告总数: 98107

Total allowlist list 允许名单总数: 1322

Total combine list 结合总数： 97978

Total deadblock list 失效屏蔽广告域名： 18662

Total deadallow list 失效允许广告域名： 93

Update 更新时间: 2020-12-10
```
### UPTODATE 保持最新<br/>
