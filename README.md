...
```
Total ad / tracking block list 屏蔽追踪广告总数: 115313

Total allowlist list 允许名单总数: 1280

Total combine list 结合总数： 115168

Total deadblock list 失效屏蔽广告域名： 29081

Total deadallow list 失效允许广告域名： 88

Update 更新时间: 2021-01-11
```
### UPTODATE 保持最新<br/>
