...
```
Total ad / tracking block list 屏蔽追踪广告总数: 124146

Total allowlist list 允许名单总数: 1232

Total combine list 结合总数： 124025

Total deadblock list 失效屏蔽广告域名： 26176

Total deadallow list 失效允许广告域名： 111

Update 更新时间: 2021-04-18
```
### UPTODATE 保持最新<br/>
