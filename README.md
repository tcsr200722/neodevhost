...
```
Total ad / tracking block list 屏蔽追踪广告总数: 127045

Total allowlist list 允许名单总数: 1234

Total combine list 结合总数： 126925

Total deadblock list 失效屏蔽广告域名： 28901

Total deadallow list 失效允许广告域名： 108

Update 更新时间: 2021-04-05
```
### UPTODATE 保持最新<br/>
