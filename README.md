...
```
Total ad / tracking block list 屏蔽追踪广告总数: 121507

Total allowlist list 允许名单总数: 1235

Total combine list 结合总数： 121368

Total deadblock list 失效屏蔽广告域名： 30569

Total deadallow list 失效允许广告域名： 107

Update 更新时间: 2021-03-01
```
### UPTODATE 保持最新<br/>
