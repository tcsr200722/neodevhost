...
```
Total ad / tracking block list 屏蔽追踪广告总数: 96881

Total allowlist list 允许名单总数: 1320

Total combine list 结合总数： 96754

Total deadblock list 失效屏蔽广告域名： 18266

Total deadallow list 失效允许广告域名： 94

Update 更新时间: 2020-12-04
```
### UPTODATE 保持最新<br/>
