...
```
Total ad / tracking block list 屏蔽追踪广告总数: 130758

Total allowlist list 允许名单总数: 1243

Total combine list 结合总数： 130632

Total deadblock list 失效屏蔽广告域名： 25648

Total deadallow list 失效允许广告域名： 102

Update 更新时间: 2021-05-27
```
### UPTODATE 保持最新<br/>
