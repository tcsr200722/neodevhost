...
```
Total ad / tracking block list 屏蔽追踪广告总数: 115423

Total allowlist list 允许名单总数: 1253

Total combine list 结合总数： 115283

Total deadblock list 失效屏蔽广告域名： 28763

Total deadallow list 失效允许广告域名： 88

Update 更新时间: 2021-01-13
```
### UPTODATE 保持最新<br/>
