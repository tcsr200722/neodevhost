...
```
Total ad / tracking block list 屏蔽追踪广告总数: 126407

Total allowlist list 允许名单总数: 1241

Total combine list 结合总数： 126281

Total deadblock list 失效屏蔽广告域名： 26264

Total deadallow list 失效允许广告域名： 104

Update 更新时间: 2021-05-11
```
### UPTODATE 保持最新<br/>
