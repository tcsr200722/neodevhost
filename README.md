...
```
Total ad / tracking block list 屏蔽追踪广告总数: 128006

Total allowlist list 允许名单总数: 1242

Total combine list 结合总数： 127881

Total deadblock list 失效屏蔽广告域名： 26148

Total deadallow list 失效允许广告域名： 103

Update 更新时间: 2021-05-12
```
### UPTODATE 保持最新<br/>
