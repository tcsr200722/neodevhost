...
```
Total ad / tracking block list 屏蔽追踪广告总数: 98762

Total allowlist list 允许名单总数: 1323

Total combine list 结合总数： 98633

Total deadblock list 失效屏蔽广告域名： 17031

Total deadallow list 失效允许广告域名： 89

Update 更新时间: 2020-11-10
```
### UPTODATE 保持最新<br/>
