...
```
Total ad / tracking block list 屏蔽追踪广告总数: 98788

Total allowlist list 允许名单总数: 1320

Total combine list 结合总数： 98659

Total deadblock list 失效屏蔽广告域名： 17787

Total deadallow list 失效允许广告域名： 94

Update 更新时间: 2020-11-28
```
### UPTODATE 保持最新<br/>
