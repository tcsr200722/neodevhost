...
```
Total ad / tracking block list 屏蔽追踪广告总数: 115399

Total allowlist list 允许名单总数: 1272

Total combine list 结合总数： 115262

Total deadblock list 失效屏蔽广告域名： 28846

Total deadallow list 失效允许广告域名： 88

Update 更新时间: 2020-12-28
```
### UPTODATE 保持最新<br/>
