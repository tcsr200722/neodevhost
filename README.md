...
```
Total ad / tracking block list 屏蔽追踪广告总数: 130810

Total allowlist list 允许名单总数: 1248

Total combine list 结合总数： 130681

Total deadblock list 失效屏蔽广告域名： 26503

Total deadallow list 失效允许广告域名： 98

Update 更新时间: 2021-06-07
```
### UPTODATE 保持最新<br/>
